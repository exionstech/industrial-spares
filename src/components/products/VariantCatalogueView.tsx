...
/*
 * Level 4, the end of the hierarchy: the catalogue for one variant. The table
 * holds the project's placeholder rows until the real catalogue data lands -
...
export const VariantCatalogueView: React.FC<VariantCatalogueViewProps> = ({
  ...
  const selection = [
    ...
    { label: "Catalogue data", value: AWAITING_DATA },
  ];
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-shell px-4 pb-20 sm:px-8 lg:pb-[120px]">
        ...
        {/* Catalogue table */}
        <div className="mt-6 overflow-x-auto border border-brand-line bg-white">
